(function(app) {
    'use strict';
    app.controller('indexCtrlindexCtrl', indexCtrl);
    ...
    function indexCtrl($scope, $location, apiService, notificationService) {
        ...
        function genresLoadCompleted(result) {
            ...
            Morris.Bar({ element: "genres-bar", data: genres, xkey: "Name", ykeys: ["NumberOfMovies"], labels: ["Number Of Movies"], barRatio: 0.4, xLabelAngle: 55, hideHover: "auto", resize: 'true' });
